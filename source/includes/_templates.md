...
The skeleton files are intentionally stored as separate YAML files so they can be copied, validated, versioned, and reused outside this documentation page.
