...
| healthStatus | boolean | boolean | The usability of the data product can be determined through (an internal automated) review that assesses the data quality, accuracy, and other characteristics to ensure its usability. In this process, a value of 'true' indicates that the automated review has deemed the product to be usable. Conversely, a value of 'false' signifies that the automated review has identified deficiencies or errors that render the product unusable. |
