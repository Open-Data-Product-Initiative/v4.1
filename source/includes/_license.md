...
| **URL**  | URL | Valid URL | Points to the license text. You can use this or then the other approach to define elements of the license with below given elements and attributes |
